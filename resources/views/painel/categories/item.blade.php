...
<div class="row">
  <div class="col-md-12">
    ...
    @endif
        ...
        <form id="form_cad" method="POST"  class="form-horizontal form-label-left" action="{{route('category.sub_store')}}">
        ...
        {!! csrf_field() !!}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="id" class="col-sm-2 control-label">Categoria:</label>
                    <div class="col-sm-8">
                    <input type="text" readonly class="form-control" id="id" name="id"  value="@if(!empty($category)){{$category->description}} @endif">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nome" class="col-sm-2 control-label">Descrição da SubCategoria:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="description" name="description" placeholder="Digite o nome da subcategoria.." value="">
                    </div>
                </div>
